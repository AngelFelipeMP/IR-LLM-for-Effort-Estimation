...
class UQV100_GOLD_LABELS_PLUST_LLMS_STATISTICAL_TEST(UQV100_GOLD_LABELS_STATISTICAL_TEST, UQV100_GOLD_LABELS_PLUST_LLMS_HISTOGRAM):
    ...
    def main(self):
        ...
        UQV100_GOLD_LABELS_STATISTICAL_TEST.person_correlation_coefficient(self)
        UQV100_GOLD_LABELS_STATISTICAL_TEST.krippendorff_alpha(self)
        UQV100_GOLD_LABELS_STATISTICAL_TEST.krippendorff_alpha_nltk(self)
